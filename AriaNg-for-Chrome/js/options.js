(function () {
  ...
  var vm = new Vue({
    ...
    methods: {
      addRPCForm: function addRPCForm() {
        this.rpcLists.push({
          name: '',
          path: ''
        });
      },
      removeRPCByIndex: function removeRPCByIndex(index) {
      ...
      clear: function clear() {
        var confirmMessage = chrome.i18n.getMessage('resetConfirm');
      ...
      showSavedInfo: function showSavedInfo() {
        var _this2 = this;
